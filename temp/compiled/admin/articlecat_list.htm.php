<!-- $Id: articlecat_list.htm 17020 2014/9/27 10:18:24Z $ -->
...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  <tr>
    <td><?php echo $this->_var['lang']['cat_name']; ?></td>
    <td width="150px" align="center"><?php echo $this->_var['lang']['type']; ?></td>
    <td width="500px" ><?php echo $this->_var['lang']['cat_desc']; ?></td>
    <td width="100px" align="center"><?php echo $this->_var['lang']['sort_order']; ?></td>
    <td width="100px" align="center"><?php echo $this->_var['lang']['show_in_nav']; ?></td>
    <td width="100px" align="center"><?php echo $this->_var['lang']['handler']; ?></td>
  </tr>
...
?>
  <tr align="center" class="<?php echo $this->_var['cat']['level']; ?>" id="<?php echo $this->_var['cat']['level']; ?>_<?php echo $this->_var['cat']['cat_id']; ?>">
    ...
    <td width="100px" align="center" class="nowrap" valign="top">
