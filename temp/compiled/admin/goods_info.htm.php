...
<tr>
<td class="label">
<font color="red"> * 自定义促销小图标：</font>
</td>
<td>
<input type="file" name="goods_ico" value="<?php echo $this->_var['goods_ico']; ?>" size="35" />
<?php if ($this->_var['goods']['goods_ico']): ?>
<a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['goods_ico']; ?>" target="_blank"><img src="images/yes.gif" border="0" /></a>
<?php else: ?>
<img src="images/no.gif" />
<?php endif; ?>
建议图片尺寸：50*50(单位：像素)
