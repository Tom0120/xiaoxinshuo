...
if(Object.prototype.toJSONString){
    Object.prototype.toJSONString = null;
  }
...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><?php echo $this->_var['lang']['radar_title']; ?></th>
...
<!-- 商品雷达 -->
 <input type="hidden" id="radar_lincense_id" value="<?php echo $this->_var['license']; ?>" />
 <input type="hidden" id="radar_product_key" value="<?php echo $this->_var['product_key']; ?>" />
 <input type="hidden" id="radar_sign_key" value="<?php echo $this->_var['radar_sign']; ?>" />
<!-- 商品雷达 end -->
<!-- end goods list -->
