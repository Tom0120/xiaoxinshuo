...
<div class="list-div">
  ...
  <tr><td>
    <table style="border:1px solid #DDDDDD;">
      <tr>
        <td width="250" align="center" style="border-right:1px solid #DDDDDD;">
		<img id="screenshot" src="<?php echo $this->_var['curr_template']['screenshot']; ?>"/>
		</td>
        <td valign="top">
		<strong>
		<span id="templateName"><?php echo $this->_var['curr_template']['name']; ?></span>
		</strong> v<span id="templateVersion"><?php echo $this->_var['curr_template']['version']; ?></span><br />
...
?>
  <div style="display:-moz-inline-stack;display:inline-block;vertical-align:top;zoom:1;*display:inline;">
    <table style="width: 250px;border:1px solid #DDDDDD;">
      <tr>
        <td align=center style="border-bottom:1px solid #DDDDDD;" ><strong><a href="<?php echo $this->_var['template']['uri']; ?>" target="_blank" ><?php echo $this->_var['template']['name']; ?></a></strong></td>
      </tr>
      <tr>
