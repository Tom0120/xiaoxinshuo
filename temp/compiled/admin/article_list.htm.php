...
<th><a href="javascript:listTable.sort('click_count')"><?php echo $this->_var['lang']['click_count']; ?></a></th>  
...
<td align="center"><span><?php if ($this->_var['list']['article_type'] == 0): ?><?php echo $this->_var['lang']['common']; ?><?php endif; ?>
<?php if ($this->_var['list']['article_type'] == 1): ?><?php echo $this->_var['lang']['top']; ?><?php endif; ?>
<?php if ($this->_var['list']['article_type'] == 2): ?>头条<?php endif; ?>
<?php if ($this->_var['list']['article_type'] == 3): ?>推荐<?php endif; ?>
<?php if ($this->_var['list']['article_type'] == 4): ?>热门<?php endif; ?></span></td>
...
<!--新增代码-->  
<td align="center"><span onclick="javascript:listTable.edit(this, 'edit_click_count', <?php echo $this->_var['list']['article_id']; ?>)"><?php echo htmlspecialchars($this->_var['list']['click_count']); ?></span></td>  
<!--end-->  
