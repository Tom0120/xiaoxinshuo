...
?>
            ...
            <img src="<?php echo $this->_var['goods']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>" style="width:260px;height:180px;"/>
            <p class="name"><?php echo sub_str($this->_var['goods']['name'],20); ?></p>
            <p>
            <span>
            孝心价：
            ...
            <!---span><?php echo $this->_var['goods']['evaluation']; ?></span--->
