...
<?php endif; ?>
<?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_93051300_1429623120');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_93051300_1429623120']):
?>

<div class="ty_sycj selectLine1 clearfix" style="border-top: 1px dotted #ccc;">
<div class="proLeft">
<?php echo htmlspecialchars($this->_var['filter_attr_0_93051300_1429623120']['filter_attr_name']); ?>
</div>
<div class="proRight clearfix">
<ul class="clearfix">
<?php $_from = $this->_var['filter_attr_0_93051300_1429623120']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
...
<a class="judge" href="<?php echo $this->_var['goods']['url']; ?>#answerArea" title="" target="_blank">已有<span><?php echo $this->_var['goods']['comment_count']; ?></span>人评价</a>
