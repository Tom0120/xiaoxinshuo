...
$_LANG['booking_js']['email_empty'] = '请输入联系人的电子邮箱！';
$_LANG['booking_js']['email_error'] = '您输入的电子邮箱格式不正确！';
...
$_LANG['edit_email_failed'] = '编辑电子邮箱失败！';
...
$_LANG['profile_js']['email_empty'] = '请输入您的电子邮箱！';
$_LANG['profile_js']['email_error'] = '您输入的电子邮箱格式不正确！';
...
$_LANG['username_no_email'] = '您填写的用户名与电子邮箱不匹配，请重新输入！';
...
$_LANG['username_not_match_email'] = '用户名与电子邮箱不匹配，请重新输入！';
...
$_LANG['password_js']['email_address_empty'] = '请输入您的电子邮箱！';
...
$_LANG['msg_email_registered'] = '电子邮箱已存在,请重新输入';
$_LANG['msg_email_format'] = '电子邮箱不合法';
...
$_LANG['your_surplus'] = '您的余额';
$_LANG['credit_line'] = '信用额度';
$_LANG['your_bonus'] = '您的红包';
$_LANG['your_message'] = '您的留言';
$_LANG['your_card'] = '身份验证';
$_LANG['your_order'] = '您的订单';
$_LANG['your_integral'] = '消费积分 ';
$_LANG['your_level'] = '%s ';
...
$_LANG['passport_js']['username_shorter'] =" <div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'>用户名长度不能少于 6 个字符。</div>";
$_LANG['passport_js']['username_invalid'] =" <div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'>用户名只能是由字母数字以及下划线组成。。</div>";
$_LANG['passport_js']['password_empty'] = '登录密码不能为空。';
$_LANG['passport_js']['password_shorter'] = " <div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'>6-16个字符，建议使用字母加数字或符号组合</div>";
$_LANG['passport_js']['confirm_password_invalid'] = " <div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'>两次输入密码不一致</div>";
$_LANG['passport_js']['email_empty'] = " <div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'> Email 为空</div>";
$_LANG['passport_js']['email_invalid'] = " <div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'> Email 不是合法的地址</div>";
...
$_LANG['passport_js']['msg_un_length'] = "<div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'>用户名最长不得超过7个汉字</div>";
$_LANG['passport_js']['msg_un_format'] = "<div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'>用户名含有非法字符</div>";
$_LANG['passport_js']['msg_un_registered'] = "<div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'>用户名已经存在,请重新输入</div>" ;
$_LANG['passport_js']['msg_can_rg'] = "<div style='width:23px;height:23px;background:url(themes/xinyu/images/ok.png) no-repeat;margin-left:270px;margin-top:-35px;position:relative;'></div>";
$_LANG['passport_js']['msg_email_blank'] = '邮件地址不能为空';
$_LANG['passport_js']['msg_email_registered'] = "<div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'> 电子邮箱已存在,请重新输入</div>";
$_LANG['passport_js']['msg_email_format'] = " <div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'> 邮件地址不合法</div>";
$_LANG['passport_js']['msg_blank'] = '不能为空';
$_LANG['passport_js']['no_select_question'] = '- 您没有完成密码提示问题的操作';
$_LANG['passport_js']['passwd_balnk'] = "<div style='width:20px;height:20px;background:url(themes/xinyu/images/err.png) no-repeat;position:relative;padding-left:25px;'> 密码中不能包含空格</div>";
