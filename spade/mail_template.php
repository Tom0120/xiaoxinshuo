...
if ($_REQUEST['act'] == 'list')
{
    ...
    /* 创建 html editor */
    $FCKeditor = create_html_kindeditor('content', $content['template_content'], 'theForm');// 最后一个参数theForm是新增的，可以指定后台包含编辑器的表单的名字。  
...
$kindeditor = "<script src='http://localhost/wwwxiaoxinshuocom/includes/kindeditor/kindeditor-all-min.js' charset='utf-8'></script>
<script charset='utf-8' src='http://localhost/wwwxiaoxinshuocom/includes/kindeditor/kindeditor-min.js'></script>
 
<script src='http://localhost/wwwxiaoxinshuocom/includes/kindeditor/lang/zh_CN.js' charset='utf-8'></script>
<script src='http://localhost/wwwxiaoxinshuocom/includes/kindeditor/plugins/code/prettify.js' charset='utf-8'></script>
<script>KindEditor.ready(function(K) {
var editor1 = K.create('textarea[name=".$input_name."]',{
cssPath : 'http://localhost/wwwxiaoxinshuocom/includes/kindeditor/plugins/code/prettify.css',
uploadJson : 'http://localhost/wwwxiaoxinshuocom/includes/kindeditor/php/upload_json.php',
fileManagerJson : 'http://localhost/wwwxiaoxinshuocom/includes/kindeditor/php/file_manager_json.php',
afterBlur : function() {
this.sync();
...
<textarea id=\"$input_name\" name=\"$input_name\" style='width:700px;height:350px;'>$input_value</textarea>";
